...
import { upgradeTranslations } from "./UpgradeLanguages";
import { loginTranslations } from "./LoginLanguages";
...
export const othersTranslations = {
	en: {
		...
		humidity: "Humidity",
		searching: "Search equipment",
		url: "https://www.lcsd.gov.hk/clpss/en/webApp/Facility/District.do?ftid=161",
	},
	zh: {
		intro:
		...
		humidity: "濕度",
		searching: "搜尋",
		url: "https://www.lcsd.gov.hk/clpss/tc/webApp/Facility/District.do?ftid=161",
	},
};
