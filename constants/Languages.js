...
export const sessionTranslations = {
	en: {
		sessionHub: "Exercise Session",
		sessionHubTitle: "Exercise Session",
		sessionHubSubtitle: "Start a new exercise session or review your saved session records.",
		sessionRecord: "Session Record",
		sessionRecordHint: "Start timing an outdoor or home exercise session.",
		sessionLog: "Session Log",
		sessionLogHint: "View and manage your saved session history.",
		sessionTimerTitle: "Exercise Session",
		sessionStart: "Start",
		sessionPause: "Pause",
		sessionResume: "Resume",
		sessionEnd: "End Session",
		sessionNotStarted: "Please start the timer first.",
		sessionSummaryTitle: "Session Summary",
		sessionCompletedAt: "Completed at",
		sessionDuration: "Duration",
		sessionType: "Session Type",
		sessionTypeOutdoor: "Outdoor",
		sessionTypeHome: "Home",
		emotionScale: "Emotion Scale",
		emotionHint: "1 = Very low, 5 = Very positive",
		rpeScale: "Rate of Perceived Exertion",
		rpeHint: "1 = Very light, 10 = Maximal effort",
		showMore: "Show more",
		hideMore: "Show less",
		sessionJournal: "Session Journal",
		sessionJournalPlaceholder: "How do you feel after this session?",
		...
		doneAerobic: "Aerobic exercise done",
		doneBalance: "Balance exercise done",
		doneStrength: "Muscle strengthening done",
		goalProgressPlaceholder: "Weekly goal progress",
		goalProgressTitle: "Weekly goal progress",
		...
		discardSessionTitle: "End without saving?",
		discardSessionMessage: "Your timer will stop. Continue to the summary page to save this session.",
		continueToSummary: "Continue",
		cancelTimer: "Cancel",
		exercisesCount: "%{count} exercise(s)",
		noneSelected: "Not selected",
		activityTypesDone: "Completed activity types",
	},
	zh: {
		sessionHub: "運動時段",
		sessionHubTitle: "運動時段",
		sessionHubSubtitle: "開始新的運動記錄，或查看已儲存的時段日誌。",
		sessionRecord: "運動記錄",
		sessionRecordHint: "開始為戶外或居家運動計時。",
		sessionLog: "記錄日誌",
		sessionLogHint: "查看和管理已儲存的時段記錄。",
		sessionTimerTitle: "運動時段",
		sessionStart: "開始",
		sessionPause: "暫停",
		sessionResume: "繼續",
		sessionEnd: "結束時段",
		sessionNotStarted: "請先開始計時。",
		sessionSummaryTitle: "時段摘要",
		sessionCompletedAt: "完成時間",
		sessionDuration: "時長",
		sessionType: "時段類型",
		sessionTypeOutdoor: "戶外",
		sessionTypeHome: "居家",
		emotionScale: "情緒量表",
		emotionHint: "1 = 很低落，5 = 很正面",
		rpeScale: "自覺用力程度",
		rpeHint: "1 = 非常輕鬆，10 = 竭盡全力",
		showMore: "顯示更多",
		hideMore: "收起",
		sessionJournal: "運動日誌",
		sessionJournalPlaceholder: "完成這次運動後的感受？",
		exerciseRecords: "運動類型記錄",
		addExercise: "新增運動",
		selectEquipment: "選擇器材",
		reps: "次數",
		repsPlaceholder: "例如 10",
		removeExercise: "移除",
		doneAerobic: "已完成帶氧運動",
		doneBalance: "已完成平衡力訓練",
		doneStrength: "已完成肌肉強化",
		goalProgressPlaceholder: "每週目標進度",
		goalProgressTitle: "每週目標進度",
		saveAndContinue: "儲存並繼續",
		sessionSaved: "時段已儲存。",
		noSessions: "尚未有已儲存的時段記錄。",
		sessionDetailTitle: "時段詳情",
		deleteSession: "刪除",
		deleteSessionConfirm: "確定刪除此時段記錄？",
		backHome: "返回主頁",
		discardSessionTitle: "結束時段？",
		discardSessionMessage: "計時將停止，請在摘要頁儲存此次記錄。",
		continueToSummary: "繼續",
		cancelTimer: "取消",
		exercisesCount: "%{count} 項運動",
		noneSelected: "未選擇",
		activityTypesDone: "已完成活動類型",
	},
};
...
export const goalTranslations = {
	en: {
		...
		goalHubTitle: "Goal Setting",
		goalHubSubtitle: "Set weekly exercise targets and personal SMART goals.",
		goalAerobic: "Aerobic",
		goalBalance: "Balance",
		goalStrength: "Muscle strengthening",
		goalAerobicHint: "Weekly days of aerobic exercise",
		goalBalanceHint: "Weekly days of balance training",
		goalStrengthHint: "Weekly days of muscle strengthening",
		goalSmart: "SMART goal",
		goalSmartHint: "Write and track your personal SMART goals.",
		goalEditTargetTitle: "Weekly target",
		goalTargetDays: "Target days per week",
		goalDaysUnit: "day(s)",
		goalProgressOf: "%{done} / %{target} days",
		goalSaveTarget: "Save target",
		goalTargetSaved: "Target saved.",
		goalSmartTitle: "SMART goals",
		goalSmartGuidanceTitle: "How to write a SMART goal",
		goalSmartGuidance:
			"S – Specific: say exactly what you will do.\nM – Measurable: include a number you can count.\nA – Achievable: match your current ability.\nR – Relevant: link it to your health or rehab needs.\nT – Time-bound: set a clear weekly timeframe.",
		goalSmartPlaceholder: "e.g. Walk outdoors for 20 minutes on 3 days this week.",
		goalSmartAdd: "Add SMART goal",
		goalSmartSave: "Save SMART goals",
		goalSmartSaved: "SMART goals saved.",
		goalSmartEmpty: "No SMART goals yet.",
		goalSmartRemove: "Remove",
		goalWeeklyCalendar: "This week",
		goalCarryTitle: "New week started",
		goalCarryMessage: "Keep the same goals for this week?",
		goalCarryKeep: "Keep same goals",
		goalCarryEdit: "Edit goals",
		goalHomeSmartTitle: "My SMART goals",
	},
	zh: {
		goalSetting: "目標設定",
		goalHubTitle: "目標設定",
		goalHubSubtitle: "設定每週運動目標，以及個人 SMART 目標。",
		goalAerobic: "帶氧運動",
		goalBalance: "平衡力訓練",
		goalStrength: "肌肉強化",
		goalAerobicHint: "每週帶氧運動天數",
		goalBalanceHint: "每週平衡力訓練天數",
		goalStrengthHint: "每週肌肉強化天數",
		goalSmart: "SMART 目標",
		goalSmartHint: "撰寫並追蹤個人 SMART 目標。",
		goalEditTargetTitle: "每週目標",
		goalTargetDays: "每週目標天數",
		goalDaysUnit: "天",
		goalProgressOf: "%{done} / %{target} 天",
		goalSaveTarget: "儲存目標",
		goalTargetSaved: "目標已儲存。",
		goalSmartTitle: "SMART 目標",
		goalSmartGuidanceTitle: "如何撰寫 SMART 目標",
		goalSmartGuidance:
			"S – 具體（Specific）：清楚說明要做什麼。\nM – 可衡量（Measurable）：包含可計算的數字。\nA – 可達成（Achievable）：符合目前能力。\nR – 相關（Relevant）：連結健康或復康需要。\nT – 有時限（Time-bound）：訂明一週內的時間範圍。",
		goalSmartPlaceholder: "例如：本週有 3 天到戶外步行 20 分鐘。",
		goalSmartAdd: "新增 SMART 目標",
		goalSmartSave: "儲存 SMART 目標",
		goalSmartSaved: "SMART 目標已儲存。",
		goalSmartEmpty: "尚未設定 SMART 目標。",
		goalSmartRemove: "移除",
		goalWeeklyCalendar: "本週",
		goalCarryTitle: "新的一週已開始",
		goalCarryMessage: "是否沿用相同目標到本週？",
		goalCarryKeep: "沿用相同目標",
		goalCarryEdit: "重新設定",
		goalHomeSmartTitle: "我的 SMART 目標",
	},
};
